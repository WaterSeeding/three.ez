...
export interface Object3DExtPrototype {
  ...
  on<K extends keyof Events>(
    type: K | K[],
    listener: (this: this, event?: Events[K]) => void
  ): (event?: Events[K]) => void;
  /**
   ...
   */
  hasEvent<K extends keyof Events>(
    type: K,
   ...
   * @param event - Optional event data to pass to the listeners.
   */
  triggerAncestor<K extends keyof InteractionEvents>(
    type: K,
    event?: InteractionEvents[K]
  ): void;
  /**
   ...
   */
  bindProperty<T extends keyof this>(
    property: T,
    getCallback: () => this[T],
...
Object.defineProperty(Object3D.prototype, "visible", {
  ...
  set: function (this: Object3D, value: boolean) {
    if (this.__visible !== value) {
      ...
      this.__eventsDispatcher.dispatchDescendant("visiblechange", {
        value,
        target: this,
      });
    }
...
Object.defineProperty(Object3D.prototype, "enabled", {
  ...
  set: function (this: Object3D, value: boolean) {
    if (this.__enabled !== value) {
      ...
      this.__eventsDispatcher.dispatchDescendant("enabledchange", {
        value,
        target: this,
      });
    }
...
Object3D.prototype.on = function <K extends keyof Events>(
  this: Object3D,
  types: K | K[],
  listener: (event: Events[K]) => void
): (event: Events[K]) => void {
...
Object3D.prototype.hasEvent = function <K extends keyof Events>(
  type: K,
  listener: (event: Events[K]) => void
): boolean {
...
Object3D.prototype.off = function <K extends keyof Events>(
  type: K,
  listener: (event: Events[K]) => void
): void {
...
Object3D.prototype.trigger = function <T extends keyof Events>(
  type: T,
  event?: Events[T]
): void {
...
Object3D.prototype.triggerAncestor = function <T extends keyof Events>(
  type: T,
  event?: Events[T]
): void {
...
Object.defineProperty(Object3D.prototype, "userData", {
  // needed to inject code in constructor
...
Object3D.prototype.bindProperty = function (
  property,
  getValue,
  renderOnChange
) {
